...
function clickHandler(e) {
    ...
    if (bdayStr !== '') {
        ...
        if (isPalindrome) {
            ...
            resultRef.innerText = `sorry!☹️ your birthday is not a pallindrome, the next palindrome date is ${nextDate.day}-${nextDate.month}-${nextDate.year}, you missed it by ${ctr} days! 😔`;
        }
    }
}
